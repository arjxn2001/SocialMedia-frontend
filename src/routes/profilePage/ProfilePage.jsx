...
const ProfilePage = () => {
  ...
  if (!data) return <div className="text-center mt-10">User not found!</div>;

  return (
    <div className="profilePage flex flex-col items-center gap-3 mt-6">
      <img
      ...
      <div className="profileInteractions flex gap-8 mt-2 items-center">
        <Share />
        <div className="profileButtons flex items-center gap-4">
          <button className="bg-gray-300 font-semibold px-4 py-2 rounded-2xl hover:bg-gray-400">
            Message
          </button>
      ...
      <div className="profileOptions flex gap-10 mt-8 font-bold">
        <span
          ...
          className={`cursor-pointer pb-2 hover:text-gray-600 ${
            type === 'created' ? 'border-b-2 border-black' : ''
          }`}
        >
          Created
        </span>
        <span
          ...
          className={`cursor-pointer pb-2 hover:text-gray-600 ${
            type === 'saved' ? 'border-b-2 border-black' : ''
          }`}
        >
          Saved
        </span>
