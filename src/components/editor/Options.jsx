...
const Options = ({previewImg}) => {
  ...
  const handleSizeClick = (size) =>{
    ...
    if(size==="original"){
      ...
      if((originalOrientation==="portrait" && canvasOptions.orientation ==="portrait")  || (originalOrientation==="landscape" && canvasOptions.orientation ==="landscape") 
      ){
        newHeight = (375 * previewImg.height) / previewImg.width;
      }else{
        newHeight = (375 * previewImg.width) / previewImg.height;
